...
const newsDataItem6 = {
    ...
    今大会、NomadicTribeからは「ノマ」と「トラ」の2チーム編成で出場。2026シーズンの初陣として、1月の始動から積み上げてきた練習の成果を試す重要な大会となりました。<br>
    結果、両チームとも予選から着実に勝利を積み重ね、決勝戦での「身内対決」を実現。激闘の末、ノマが勝利し、NomadicTribeとして優勝・準優勝という最高の結果を収めることができました。</p>

    <h3>大会結果</h3>
    <ul>
        <li>NomadicTribe ノマ：優勝</li>
        <li>NomadicTribe トラ：準優勝</li>
    </ul>
    <div class="news-photo-grid">
        <figure class="news-photo">
            <img src="images/news/news_6_noma.jpg" alt="NomadicTribe ノマ 集合写真">
            <figcaption>NomadicTribe ノマ</figcaption>
        </figure>
        <figure class="news-photo">
            <img src="images/news/news_6_tora.jpg" alt="NomadicTribe トラ 集合写真">
            <figcaption>NomadicTribe トラ</figcaption>
        </figure>
    </div>
    ...
    <h3>個人賞</h3>
    <ul>
        <li>MVP：尾崎 聡大（NomadicTribeノマ)</li>
        <li>Fighting-spirit award：村上 吏旺（NomadicTribeトラ）</li>
    </ul>
    <div class="news-photo-grid">
        <figure class="news-photo">
    ...
    <h3>試合詳細</h3>
    <h4>NomadicTribe ノマ（結果：優勝 / 6勝0敗）</h4>
    ...
    <ul>
        ...
        <li>2/15 (Sun) vs NomadicTribe トラ ｜ 11-6 ○</li>
    </ul>

    <h4>NomadicTribe トラ（結果：準優勝 / 5勝1敗）</h4>
    ...
    <ul>
        ...
        <li>2/15 (Sun) vs NomadicTribe ノマ ｜ 6-11 ●</li>
    </ul>
    ...
    2026シーズン、NomadicTribeはさらなる高みを目指して走り続けます。引き続き応援のほど、よろしくお願いいたします！</p>
    `
};
